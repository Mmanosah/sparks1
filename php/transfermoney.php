...
<body>
    ...
    include './navbar.php';
    ?>
    <div class="center mt-0 #F9CEEE accent-3 header1">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="center"><a href="userdetails.php?c_id=<?php echo $rows['c_id']; ?>"> <button type="button" class="btn btn-primary" > Transfer Money<i class="material-icons right">attach_money</i></button></a></td>
                                    </tr>
                            <?php
                                }
                            }
