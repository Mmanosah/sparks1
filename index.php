...
<body>
  <nav>
    <div class="container-fluid nav-wrapper darken-3 z-depth-5 nav1">
        ...
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="./images/perform.jpg">
            </div>
            <button onclick="location.href='./php/transfermoney.php'" style="color:black; background-color :  #F9CEEE;" class="waves-effect waves-light #F9CEEE accent-4 btn-large textcolor"><b>Perform Transactions💶</b><i class="material-icons right">add_circle</i></button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            ...
            <button type="button" onclick="location.href='./php/transactionhistory.php'" style="color:black; background-color:#F9CEEE;" class="waves-effect waves-light #F9CEEE accent-4 btn-large textcolor"><b> Transaction History🔎</b><i class="material-icons right">send</i></button>
          </div>
        </div>
      </div>
    </div>
